...
public class Grubit {
    ...
    // Method to show upgrade reminder
    private void upgradeReminder() {
        JOptionPane.showMessageDialog(frame, "Don't forget to upgrade to Grubit Plus! \nVisit: https://www.goodfoods.com/");
        JOptionPane.showMessageDialog(frame, "Visit Good Food for more recipes!");
    }
